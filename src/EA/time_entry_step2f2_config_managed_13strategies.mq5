...
//| Step 2F.2: Config-managed 13 strategy EA                         |
//+------------------------------------------------------------------+
#property strict
...
void PrintDebug(string strategy, string message)
{
   if(InpPrintDebug)
   {
      Print("[Step2F.2 ", strategy, "] ", message);
   }
}
...
{
   string name = "TE_STEP2F2_" + cfg.strategy_code + "_" + cfg.symbol + "_" + IntegerToString(cfg.magic) + "_" + IntegerToString(date_key);
...
{
   SetStrategy(0, InpEnable_17_EA_1B, "17_EA_1B_Wed_Short", "17_EA_1B", "EURAUD", 17001, DIR_SHORT, 9, 59, 20, 58, 70.0, 175.0, "17_EA_1B_step2f2", RULE_NONE);
   SetWeekdays(strategies[0], false, false, false, true, false, false, false);

   SetStrategy(1, InpEnable_18_EA_2, "18_EA_2_MonWed_Short", "18_EA_2", "EURAUD", 18002, DIR_SHORT, 9, 59, 5, 26, 90.0, 180.0, "18_EA_2_step2f2", RULE_NONE);
   SetWeekdays(strategies[1], false, true, true, true, false, false, false);

   SetStrategy(2, InpEnable_19_EA_3, "19_EA_3_WedThu_Long", "19_EA_3", "EURAUD", 19003, DIR_LONG, 20, 56, 10, 0, 90.0, 0.0, "19_EA_3_step2f2", RULE_NONE);
   SetWeekdays(strategies[2], false, false, false, true, true, false, false);

   SetStrategy(3, InpEnable_21_GA_B3, "21_GA_B_3", "21_GA_B3", "GBPAUD", 21003, DIR_LONG, 21, 2, 10, 0, 220.0, 100.0, "21_GA_B_3_step2f2", RULE_NONE);
   SetWeekdays(strategies[3], false, true, false, false, false, false, false);

   SetStrategy(4, InpEnable_22_GA_C2, "22_GA_C_2", "22_GA_C2", "GBPAUD", 22002, DIR_LONG, 16, 56, 1, 15, 70.0, 80.0, "22_GA_C_2_step2f2", RULE_NONE);
   SetWeekdays(strategies[4], false, false, false, false, true, false, false);

   SetStrategy(5, InpEnable_23_GA_F2, "23_GA_F_2", "23_GA_F2", "GBPAUD", 23002, DIR_SHORT, 19, 42, 22, 45, 90.0, 200.0, "23_GA_F_2_step2f2", RULE_NONE);
   SetWeekdays(strategies[5], false, false, false, false, false, true, false);

   SetStrategy(6, InpEnable_24_GA_D1, "24_GA_D_1", "24_GA_D1", "GBPAUD", 24001, DIR_LONG, 22, 44, 3, 8, 90.0, 200.0, "24_GA_D_1_step2f2", RULE_NONE);
   SetWeekdays(strategies[6], false, false, false, false, false, true, false);

   SetStrategy(7, InpEnable_5_GJ_Log2, "5_GJ_Port_Log2", "5_GJ_Log2", "GBPJPY", 50002, DIR_SHORT, 9, 55, 23, 55, 90.0, 0.0, "5_GJ_Port_Log2_step2f2", RULE_NONE);
   SetWeekdays(strategies[7], false, false, true, false, true, true, false);

   SetStrategy(8, InpEnable_12_UJ_Short_Core, "12_UJ_Short_Core", "12_UJ_Short_Core", "USDJPY", 12001, DIR_SHORT, 8, 4, 14, 56, 50.0, 0.0, "12_UJ_Short_Core_step2f2", RULE_UJ_SHORT_CORE);
   SetWeekdays(strategies[8], false, true, true, true, true, true, false);

   SetStrategy(9, InpEnable_13_UJ_Fix_MidWeek, "13_UJ_Fix_MidWeek", "13_UJ_Fix_MidWeek", "USDJPY", 13001, DIR_LONG, 18, 4, 22, 3, 95.0, 95.0, "13_UJ_Fix_MidWeek_step2f2", RULE_UJ_FIX_MIDWEEK);
   SetWeekdays(strategies[9], false, false, false, true, true, false, false);

   SetStrategy(10, InpEnable_14_UJ_Sat_3rd, "14_UJ_Sat_3rd", "14_UJ_Sat_3rd", "USDJPY", 14001, DIR_SHORT, 20, 1, 3, 8, 45.0, 70.0, "14_UJ_Sat_3rd_step2f2", RULE_UJ_SAT_3RD);
   SetWeekdays(strategies[10], false, true, true, true, true, true, false);

   SetStrategy(11, InpEnable_15_UJ_Sat_Aug, "15_UJ_Sat_Aug", "15_UJ_Sat_Aug", "USDJPY", 15001, DIR_SHORT, 19, 0, 23, 30, 20.0, 35.0, "15_UJ_Sat_Aug_step2f2", RULE_UJ_SAT_AUG);
   SetWeekdays(strategies[11], false, true, true, true, true, true, false);

   SetStrategy(12, InpEnable_16_UJ_T10A, "16_UJ_T10A", "16_UJ_T10A", "USDJPY", 16001, DIR_LONG, 2, 58, 9, 50, 45.0, 110.0, "16_UJ_T10A_step2f2", RULE_UJ_T10A);
...
int OnInit()
{
   ...
   PrintDebug("EA", "Step 2F.2 initialized.");
   PrintDebug("EA", "Config-managed 13 strategy EA.");
...
void OnDeinit(const int reason)
{
   ...
   PrintDebug("EA", "Step 2F.2 deinitialized. Reason=" + IntegerToString(reason));
}
