...
Daily Stop is still OFF in this accepted output. The next program may read the frozen CSV but must not load M1 data or recalculate baseline trades. Threshold selection is confined to IS; OOS1 and OOS2 remain untouched until reporting.
