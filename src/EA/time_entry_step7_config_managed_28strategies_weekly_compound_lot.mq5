...
{
   PrintDebug("EA", "Step 7 Weekly compound lot initialized.");
   PrintDebug("EA", "Config-managed 28 strategy EA with final stops and weekly compound lot.");
